...
from trailer_pose_network.models.temp_tests.resnet_encoder_test import AsyncSpaceTimeCrossAttention
...
WEIGHT_FILE = "TEMPTEST_async_space_time_cross_attn_v1.pth"
...
def train():
    ...
    # Load model
    model = AsyncSpaceTimeCrossAttention(resnet_model=torchvision.models.resnet34(weights='IMAGENET1K_V1'),
                                         img_size=IMG_SIZE,
