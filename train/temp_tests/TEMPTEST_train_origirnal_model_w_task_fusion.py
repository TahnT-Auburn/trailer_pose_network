...
from trailer_pose_network.models.temp_tests.TEMPTEST_task_fusion_test import AsyncSpaceTimeCrossAttention
...
WEIGHT_FILE = "TEMPTEST_TASK_FUSION_async_space_time_cross_attn_v2.pth"
