...
# Mango Net
class MangoNet2(nn.Module):
    # Network Initialisation
    def __init__(self, params):
        super(MangoNet2, self).__init__()
        ...
        # Convolution Layers
        self.conv1 = nn.Conv2d(channels, init_f, kernel_size=3, padding=1)      #Three channel, 16 filters, 3x3 kernel 
        ...
        h,w=findConv2dOutShape(height,width,self.conv3)
