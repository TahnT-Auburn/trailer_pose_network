...
TRAIN_CSV = '/home/gavlab/Trailer_Pitch_Estimate/TrainingData/RoadRunner/TrainingData/Combined/combined_one_instance.csv'
...
torch.save(model_weights, "mango_net.pth")
