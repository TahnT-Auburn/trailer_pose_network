...
TRAIN_CSV = '/home/tahn/Software/Networks/trailer_pose_network/trailer_pose_network/data/reduced/reduced_data_v2.csv'
OUT_PATH = '/home/tahn/Software/Networks/trailer_pose_network/trailer_pose_network/weights/'
...
optimizer = torch.optim.Adam(model.parameters(), lr=3e-7, weight_decay=1e-5)
...
network_trainer = Trainer(model=model,
                          ...
                          save_weights={"cond": True, "save_path": OUT_PATH + "vanilla_w7.pth"})

outs = network_trainer.train(epochs=5)
...
# plot std
# plt.subplot(3,1,3)
# plt.plot(outs["std_train_history"], '-o')
# plt.plot(outs["std_val_history"], '-o')
# plt.legend(['train', 'val'], loc='upper right')
# plt.xlabel('Epochs')
# plt.ylabel('Error STD [deg]')
# plt.show()