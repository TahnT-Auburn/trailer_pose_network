...
from trailer_pose_network.models.visual_odometry.resnet_based_visual_odom_model import ResNetBasedVisualOdom
...
WEIGHT_FILE = "resnet_based_visual_odom_v3.pth"
