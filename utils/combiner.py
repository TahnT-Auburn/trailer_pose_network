...
parent_directory_path = 'C:\\Users\\pzt0029\\Documents\\Networks\\trailer_pose_network\\trailer_pose_network\\data\\testing\\processed'
sub_directories_path = os.listdir(parent_directory_path)

output_directory_path = 'C:\\Users\\pzt0029\\Documents\\Networks\\trailer_pose_network\\trailer_pose_network\\data\\testing\\combined\\combined_data.csv'
...
with open(output_directory_path, 'w') as file:
    ...
    for folder in sub_directories_path:
        ...
        for subfolder in subfolders:
            ...
            print(path)
            csv_file = path+subfolder+"_testing.csv"
